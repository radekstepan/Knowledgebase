        ...
        <div class="container">
            <div id="text" class="push-1 span-22 last">
                <div class="span-22 last">                    
                    <form action="<?php $this->url('/text/edit/' . $saved['slug']); ?>" method="post">
                    <h2>Edit "<?php echo $saved['title']; ?>"
                        <input class="button" onclick="selectToInput();" type="submit" value="Save" />
                        <a href="<?php $this->url('/text/view/' . $saved['slug']); ?>">(or go back)</a></h2>
                    <div class="span-11">
                        <?php include 'application/views/textarea.tpl.php'; ?>
                    </div>
                    <div id="details" class="span-11 last">
                        <div class="span-11 last">
                            <label>Title:</label><input disabled type="text" name="title" value="<?php echo $saved['title']; ?>" />
                        </div>
                        <div class="span-11 last">
